...
class LocalScreenshotProvider extends ScreenshotProvider {
  ...
  async captureScreenshot(hideSelectors = []) {
    ...
    try {
      ...
      // Scroll to trigger lazy loading (from working version fbb2b00)
      ...
      // Wait for images like the working version did
      ...
      // Hide overlay elements if specified
      ...
      console.log('Local browser: Waiting for page to re-render...');
